...
namespace CData.Compiler {
    ...
    internal sealed class ClassInfo : GlobalTypeInfo {
        ...
        public override void MapMembers() {
            ...
            if (typeSymbol != null) {
                ...
                for (var i = 0; i < memberSymbolList.Count; ) {
                    ...
                    var propAttData = memberSymbol.GetAttributeData(EX.ContractPropertyAttributeNameParts);
                    if (propAttData != null) {
        ...
        public override void GetSyntax(List<MemberDeclarationSyntax> list, ExpressionSyntax assMdExpr) {
            ...
            memberList.Add(CS.Method(CS.PublicStaticTokenList, CS.BoolType, "TryLoad", new[] {
                    ...
                    CS.Parameter(EX.DiagContextName, "context"),
    ...
    internal sealed class PropertyInfo {
        ...
        public ExpressionSyntax GetMetadataSyntax() {
            ...
            return CS.NewObjExpr(EX.PropertyMetadataName, CS.Literal(Name), Type.GetMetadataSyntax(),
    ...
    internal sealed class GlobalTypeRefInfo : LocalTypeInfo {
        ...
        public override ExpressionSyntax GetMetadataSyntax() {
            if (IsAtom) {
                ...
                return CS.InvoExpr(CS.MemberAccessExpr(EX.GlobalTypeRefMetadataExpr, "GetAtom"), EX.Literal(Kind), CS.Literal(IsNullable));
            }
            //>new GlobalTypeRefMetadata(XXX.__ThisMetadata, isNullable)
            return CS.NewObjExpr(EX.GlobalTypeRefMetadataName, GlobalType.MetadataRefSyntax, CS.Literal(IsNullable));
        }
    }
    ...
    internal sealed class CollectionInfo : LocalTypeInfo {
        ...
        public override ExpressionSyntax GetMetadataSyntax() {
            ...
            return CS.NewObjExpr(EX.CollectionMetadataName,
